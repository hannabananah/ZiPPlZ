...
public interface PortfolioRepository extends JpaRepository<Portfolio, Integer> {
    @Query(value = "SELECT p.portfolio_serial as portfolio_serial, p.worker as worker, u.user_name as user_name, YEAR(u.birth_date) as birth_date, p.career as career, p.field_id as field_id, f.field_name as field_name, w.certificated_badge as certificated_badge " +
            "FROM Portfolio p " +
            "LEFT JOIN Worker w on w.worker_serial = p.user_serial" +
